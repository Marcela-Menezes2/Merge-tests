...
class StoriesViewController: UIViewController, UICollectionViewDataSource {
   ...
   // var tableView = PostHomeTableViewCell()
    ...
    let stories: [String] = ["profile3", "profile4", "profile1", "profile", "profile4", "profile5", "profile6", "profile7", "profile8", "profile", "profile1", "profile2", "profile3", "profile4", "profile5", "profile6", "profile7", "profile8", "profile9"]
